...
impl AssocOp {
    ...
    pub fn from_token(t: &Token) -> Option<AssocOp> {
        ...
        match *t {
            ...
            Token::DotDotEquals => Some(DotDotEquals),
            Token::DotDotDot => Some(DotDotEquals), // remove this after SNAP
    ...
    pub fn fixity(&self) -> Fixity {
        ...
        match *self {
            ...
            DotDot | DotDotEquals => Fixity::None
        }
    }
    ...
    pub fn is_comparison(&self) -> bool {
        ...
        match *self {
            ...
            DotDot | DotDotEquals | Colon => false
        }
    }
    ...
    pub fn is_assign_like(&self) -> bool {
        ...
        match *self {
            ...
            LOr | DotDot | DotDotEquals | Colon => false
        }
    }
    ...
    pub fn to_ast_binop(&self) -> Option<BinOpKind> {
        ...
        match *self {
            ...
            Inplace | Assign | AssignOp(_) | As | DotDot | DotDotEquals | Colon => None
        }
    }
}
